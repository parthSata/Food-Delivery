    ...
    <div>
      <div className="mt-14">
        ...
        <div className="flex flex-wrap gap-16 mt-12 justify-center">
          <div className="relative sm:w-1/4  flex py-10 justify-center w-full h-[350px] ">
            <div className="w-full flex justify-center ">
              <div className="absolute -top-10 ">
                ...
                >
                  ...
                  <span className="text-[18px] text-[#DF201F]">Manager</span>
                </div>
              </div>
              <div className="h-[60%] w-full border-2 rounded-t-2xl shadow-div"></div>
            </div>
          </div>
          <div className="relative sm:w-1/4  flex py-10 justify-center w-full h-[350px] ">
            <div className="w-full flex justify-center ">
