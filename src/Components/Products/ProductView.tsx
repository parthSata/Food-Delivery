                ...
                <div className="w-full flex flex-col mt-[50px] gap-12 flex-wrap  font-semibold" style={{ fontFamily: "Bai Jamjuree" }}>
                    ...
                    <div className="flex gap-28 flex-row">
                        ...
                        <div className="flex items-start gap-2 flex-col">
                            ...
                            <div className="flex  gap-1" style={{ boxShadow: " 2px 2px 15px 2px #FFE5E5" }}>
                                <button className=" w-[40px] h-[42px]  border-r   border-gray" onClick={decrementQuantity}><i className="fa-solid fa-minus"></i></button>
                                <div className=" w-[40px] p-2.5 h-[42px]  border-r  border-gray">{quantity}</div>
                                <button className=" w-[40px] h-[42px]  border-r  border-gray" onClick={incrementQuantity}><i className="fa-solid fa-plus"></i></button>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2  font-semibold">
                        ...
                        <div className="" style={{ fontFamily: "Montserrat Alternates" }}>
                            <span className="text-[#A2A3A5] text-sm text-pretty">{product.description}</span>
                        </div>
                    </div>

                    <div className="flex gap-6 justify-around">
                        <button className="h-[70px] w-[200px] text-white text-xl  rounded-[60px] bg-[#94CD00] " onClick={handleEditOrder} style={{ boxShadow: "2px 2px 20px 2px #94CD0099" }}>Edit</button>
                        <button className="h-[70px] w-[200px] text-white text-xl  rounded-[60px] bg-[#DF201F] " onClick={handleDeleteOrder} style={{ boxShadow: "2px 2px 20px 2px #DF201F80" }}>Delete</button>
                    </div>
                </div>
            </div>
            {/* <Footer /> */}
