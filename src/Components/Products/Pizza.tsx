...
import Peperoni from '../../assets/Products/pepperoni.png'
...
function Pizza() {
    return (
        <div className="">
            <DashboardHeader />
            {/* Product Heading */}
            <div className="bg-[#f65554]  h-52 w-full hidden sm:w-full">
                <div className="flex justify-between  items-center w-full">
                    <span className="text-3xl pl-28 text-white">Pizza</span>
                    <img src={Product} alt="" className="visible sm:visible md:visible lg:visible xl:visible h-[205px] w-fit " />
                </div>
            </div>
            {/* Products */}
            <div className="">
                <div className="mt-6 w-full  flex gap-2 justify-around flex-wrap  ">
                    <div className="sm:w-1/5 mb-10  ">
                        <div className="flex justify-center font-semibold flex-col text-md items-center bg-[#FFE5E5] h-[200px] w-full rounded-[20px]">
                            <img src={Peperoni} alt="" className="h-20" />
                            <p className="" style={{ fontFamily: "Bai Jamjuree" }}>Peperoni Pizza</p>
