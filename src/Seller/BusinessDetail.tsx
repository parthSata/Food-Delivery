...
import { Email, RestaurantImg, CloudUpload, ImageOfRestaurant, BuisnessName, Owner, Address, uploadDocument, Attach } from "../Components/Config/images";
...
function BusinessDetails() {
    ...
    const validateFields = (): Partial<BusinessDetails> => {
        ...
        if (isFieldEmpty(businessData.email))
    ...
    const uploadFileToFirebase = async (file: File, folder: string): Promise<string> => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const newBusinessRef = dbRef(db, 'businessDetails/' + new Date().getTime());
                        ...
                        <div className="flex flex-col justify-center items-center ">
                            ...
                            <div className=" mx-auto relative bg-white  border-gray-300 border-none rounded-full " style={{
                                ...
                                <div className="p-4 h-36 w-36 flex flex-col items-center justify-center text-center cursor-pointer">
                                    {imageFile ? (
                                        <img src={URL.createObjectURL(imageFile) || RestaurantImg} alt="" className="h-full w-full rounded-full" />)
                                        : (
                            ...
                            <div className="flex mt-5  ">
                                <div className="flex items-center justify-center flex-col gap-6">
                                    ...
                                    <div className="flex items-center border-b">
                                        <textarea className="ml-2 p-6  text-[14px] focus:outline-none placeholder:text-[#161A1D] text-[#161A1D] h-[50px] w-[320px]  hover:border-0 font-semibold resize-none overflow-hidden"
                                            rows={4}
                                            placeholder="Address"
                                            style={{ fontFamily: "Montserrat Alternates" }}
                                            name="address"
                                        ...
                                        <div className="flex gap-2">
                                            <div className="flex-col gap-2">
                                                {uploadedDocuments.map((doc, index) => (
                                                    <div key={index} className="flex gap-1 items-center justify-center text-xs font-semibold">
