    ...
    return (
        <div className="h-full w-full">
            <div className="text-2xl flex justify-between flex-wrap font-semibold m-2">
                ...
                <Button className="w-[180px] text-white shadow-registerBtn rounded-full font-bold text-lg self-center uppercase bg-[#94CD00] h-[50px]" style={{ fontFamily: "Bai Jamjuree" }}>
            ...
            <div className="mt-6 w-full flex gap-2 justify-around flex-wrap">
                {[...Array(4)].map((_, index) => (
                    <div key={index} className="sm:w-1/5 w-full mb-10 font-semibold shadow-dashboard" style={{ fontFamily: "Bai Jamjuree" }}>
                        <img
                            src={Manchurian}
                            alt=""
