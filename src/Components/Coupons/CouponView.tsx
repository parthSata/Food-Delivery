...
function CouponView() {
    ...
    return (
        <div>
            <DashboardHeader />
            <div className="flex justify-center mt-28 items-center" style={{ fontFamily: "Montserrat Alternates" }} >
                <div className="flex flex-col gap-1 p-8 font-semibold bg-[#FFF3E5] rounded-[15px] h-auto w-[816px]  ">
                    ...
                    <div className="flex flex-row  pl-4 gap-8 text-lg">
                        ...
                        <span className="text-[#938D8E] text-justify">{couponDetail.discription}</span>
                    </div>

                    <div className="relative flex justify-center w-full gap-2  top-14   ">
                        <div className="bg-[#DF201F]  h-12 w-12 flex justify-center rounded-3xl " onClick={() => handleDeleteCoupons(couponDetail.id)}>
                            <button className="" ><i className="fa-solid fa-trash fa-lg" style={{ color: "#d4d9de" }}></i></button>
                        </div>
                        <div className="bg-[#94CD00]  h-12 w-12 flex justify-center rounded-3xl" onClick={() => handleUpdateCoupons(couponDetail.id)}>
