...
import { Logo, Online, Phone, flag, uk, us, united, uruguay } from "@/assets";
            ...
            <div className="border-black flex flex-col justify-center items-center">
              <div className="flex flex-col justify-center items-center ">
                ...
                <Button
                  ...
                  className={`bg-red-600  h-[50px] w-[247px] shadow-adminbtn rounded-3xl text-white text-[18px] md:text-[22px] mt-5 ${
