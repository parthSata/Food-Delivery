        ...
        <div className="w-full p-16 h-full flex flex-col gap-8 bg-[#161A1D] ">
            <div className="flex gap-16 flex-wrap md:flex-nowrap ">
                ...
                <div className="flex flex-col gap-10 w-full">
                    ...
                    <div className="flex flex-col gap-2 font-semibold font-popins w-full">
                        <div className="flex gap-4">
                            <img src={PhoneImg} alt="" className="h-5 w-5 " />
                            <span className=" text-[#99959E] text-sm">7874784388</span>
                        </div>
                        <div className="flex gap-4">
                            <img src={EmailImg} alt="" className="h-5  " />
                ...
                <div className="">
                    ...
                    <span className="h-20 w-full mt-4">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14751.288800621025!2d70.59453208402948!3d22.4357169734269!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3959db161a979c8b%3A0x428a8c265190c571!2sPaddhari%2C%20Gujarat%20360110!5e0!3m2!1sen!2sin!4v1722525328812!5m2!1sen!2sin" width="600" height="450" style={{ border: 0 }} loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="rounded-[15px] w-full mt-2"></iframe>
                    </span>
                </div>
            </div>
