    ...
    <div className="h-full w-full">
      ...
      <div className="sm:flex sm:flex-wrap flex-row h-full w-full ">
        ...
        <div className="h-full w-full -order-1">
          ...
          >
            ...
            <div className="">
              <textarea
                rows={4}
                className="resize-none p-2 border-[#E8E8E8] border-2 rounded-[10px] text-[#A2A3A5]  w-full h-[60px]"
                placeholder="Address"
              />
            </div>
            <div className="">
        ...
        <div className="h-full w-full order-2">
          <div
            className="flex font-semibold flex-col gap-6 p-10"
            style={{ fontFamily: "Bai Jamjuree" }}
          >
            <label className="pl-3 self-start">
            ...
            <div className="flex gap-2 bg-[#FFF3E5] rounded-[10px] border-[#FFE3C1] border-2 p-6 h-full ">
              ...
              <div className="">
                <p className="text-justify text-[#161A1D] ">
            ...
            <div className="flex justify-end gap-6">
              <img
                src={Edit}
                alt=""
                className="border-r-2 cursor-pointer pr-6 "
              />
