...
const Login: React.FC = () => {
  ...
  const reCaptchaKey = "6LfMhgwqAAAAAC0mGuKJQGqhsPxyi3hRZYQVNKaU"
          ...
          <form onSubmit={handleLogin} style={{ fontFamily: "Montserrat Alternates" }}>
            <div className="border-black flex flex-col justify-center items-center">
              <div className="flex flex-col justify-center items-center">
                ...
                <p className="text-[#A2A3A5] mt-0 text-[16px] font-semibold" style={{ fontFamily: "Bai Jamjuree" }}>{Strings.login.welcomeMessage}</p>
                ...
                <div className="mt-5 md:shrink flex flex-col gap-2">
                  ...
                  <p className="font-semibold text-[#DF201F] self-end">{Strings.login.forgotPasscode}</p>
                ...
                <div className="flex justify-center flex-col m-4">
                  ...
                  <button
                    ...
                    className={`bg-red-600 uppercase h-[50px] w-[247px] rounded-3xl text-white text-[18px] md:text-[22px] mt-5 ${isValid ? "" : "cursor-not-allowed opacity-50"}`}
              ...
              <div className="mt-4">
                <p className="text-gray-400 text-lg">
                  ...
                  <span className="text-[#161A1D] font-semibold"><Link to="/register"> {Strings.login.resgister}</Link></span>
                </p>
              </div>
            </div>
          </form >
